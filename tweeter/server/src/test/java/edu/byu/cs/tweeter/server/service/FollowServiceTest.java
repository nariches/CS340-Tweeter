...
public class FollowServiceTest {
    ...
    private FollowsDAO mockFollowDAO;
    ...
    public void setup() {
        ...
        //Mockito.when(followServiceSpy.getFollowees(request)).thenReturn(mockFollowDAO); //Commented out because it didn't work with M4A
    }
